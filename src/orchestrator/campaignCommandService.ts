...
import type { AutoStage, DiscoveryFilter } from './campaignFlow.js';
...
export interface CreateCampaignInput {
  ...
  /** Stop-point ladder (Roman's workflow 2026-08-27); defaults to 'build'. */
  autoStage: AutoStage;
  /** Cheap keep/drop rules at fast-qualify; defaults to no extra filtering. */
