...
async function main() {
  ...
  psql(`delete from status_history where business_id='gr-patras-m-k-hair-studio-mykoniatis-konstantinos' and reason like 'Роман замовив ще одну ітерацію: ТЕСТ%'`);
